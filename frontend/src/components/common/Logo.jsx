import telkomselLogo from '../../utils/logo_telkomsel_final.png'
...
export default function Logo({ size = 32 }) {
  return (
    <div className="flex items-center gap-2.5">
      ...
      <span className="text-text-tertiary text-sm font-bold flex-shrink-0">X</span>
      <img src={telkomselLogo} alt="Telkomsel" className="flex-shrink-0 object-contain" style={{ height: size, maxWidth: 120 }} />
    </div>
  )
}
