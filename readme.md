...
| **Completeness** | 0�100% � whether the answer meets the quality bar for this section |
...
| **Assumption** | A message the AI logs when it fills a gap with an inferred detail (`Message.role = 'assumption'`) |
